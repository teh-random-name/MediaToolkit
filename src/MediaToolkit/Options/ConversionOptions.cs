...
namespace MediaToolkit.Options
{
    ...
    {
        /// <summary>
        ///     Cut audio / video from existing media
        ///     <para>
        ///     Example: To cut a 15 minute section out of a 30 minute video starting
        ///     from the 5th minute: The start position would be: TimeSpan.FromMinutes(5).
        ///     The length would be: TimeSpan.FromMinutes(15)</para>
        /// </summary>
        /// <param name="seekToPosition">
        ///     <para>Specify the position to seek to, if you wish to begin the cut starting from the 5th minute, use: TimeSpan.FromMinutes(5);</para>
        /// </param>
        /// <param name="length">
        ///     <para>Specify the length of the video to cut, to cut out a 15 minute duration simply use: TimeSpan.FromMinutes(15);</para>
        /// </param>
