...
namespace MediaToolkit.Util
{
    ...
    internal static class RegexEngine
    {
        ...
        static long? GetLongValue(Match match)
        {
            try
            {
        ...
        static double? GetDoubleValue(Match match)
        {
            try
            {
        ...
        static int? GetIntValue(Match match)
        {
            try
            {
        ...
        internal static void TestAudio(string data, EngineParameters engine)
        {
            ...
            {
                var bitrateKbsRaw = matchAudioBitRate[1].ToString();
                int.TryParse(bitrateKbsRaw, out int bitrateKbs);
